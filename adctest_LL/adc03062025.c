...
/* Configure the peripherals common clocks */
  ...
  LL_TIM_EnableCounter(TIM3);         // tu puszczasz trigger
  ...
  while (1)
  {
	  ...
	  // oczekujesz: pcsel & 0b1100 == 0b1100  (bity 2 i 3 ustawione)
	    ...
	    current = adc_to_current(adc_ch2); // lub inne przetwarzanie
	    voltage_out = adc_to_voltage(adc_ch3); // lub inne przetwarzanie
