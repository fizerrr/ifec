...
uint16_t dst = 0;
 ...
 uint16_t step_fast = 10;   // większy krok przy niskim prądzie
 uint16_t step_slow = 1;    // mniejszy krok przy zbliżaniu się do granicy
 float threshold = 9.5f;    // próg, po którym przechodzimy na wolniejsze narastanie
/* USER CODE END PV */
